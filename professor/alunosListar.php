...
<head>
    ...
    <link rel="icon" type="image/png" href="imagens/logo1.jpg" />
    ...
    <div class="w3-main w3-container" style="margin-left:270px;margin-top:130px;">
        <div class="w3-panel w3-padding-large w3-card-4 w3-light-grey">
            ...
            <div class="w3-code cssHigh notranslate">
                ...
                $sql = "SELECT ID_Aluno, Nome AS Dt_Nasc FROM Aluno AS A ORDER BY A.Nome";
                ...
                if ($result->num_rows >0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo $idade;
                        echo "</td>";
                        //Atualizar e Excluir registro de alunos
                            ?>
                            <td>
                                <a href='posTreino.php?id=<?php echo $cod; ?>'><img src='imagens/Edit.png' title='Postar Treino' width='32'></a>
                            </td>
                            <td>
