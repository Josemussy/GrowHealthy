	...
	<div class="w3-main w3-container" style="margin-left:270px;margin-top:150px;margin-right:270px;">
		<div class="w3-panel w3-padding-large w3-card-4 w3-light-grey">
			...
			<div class="w3-code cssHigh notranslate">
				...
				$sql = "SELECT nome, celular, email, dt_nasc, login, id FROM Nutricionista WHERE id = '$id'";
				...
				?>
						<div class="w3-container w3-cyan">
							<h2>Altere os dados do Nutricionista</h2>
						</div>
						<form class="w3-container" action="cadNutricionista_exe.php" method="post" enctype="multipart/form-data">
					...
					<?php
						...
						<div class="w3-container w3-cyan">
							<h2>Nutricionista inexistente</h2>
						</div>
						<br>
				<?php
					}
