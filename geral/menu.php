...
<!-- menu.php -->
	...
	<div class="w3-top"   > <!--id="myOverlay" -->
		...
		<div class="w3-bar w3-theme w3-large" style="z-index:-1">
			...
			<a class="w3-bar-item w3-button w3-hide-medium w3-hide-small w3-hover-light-gray w3-padding-16" href="professor.php" onclick="w3_show_nav('menuProf')">Professores</a>
			<a class="w3-bar-item w3-button w3-hide-medium w3-hide-small w3-hover-light-gray w3-padding-16" href="disciplina.php" onclick="w3_show_nav('menuDisc')">Disciplinas</a>
			<a class="w3-bar-item w3-button w3-hide-medium w3-hide-small w3-hover-light-gray w3-padding-16" href="turma.php" onclick="w3_show_nav('menuTurma')">Turmas</a>
		</div>
	</div>
	...
	<div class="w3-sidebar w3-bar-block w3-collapse w3-animate-left" style="z-index:3;width:270px" id="mySidebar" >
		<div class="w3-bar w3-hide-large w3-large">
			<a href="javascript:void(0)" onclick="w3_show_nav('menuProf')"
			   class="w3-bar-item w3-button w3-theme w3-hover-light-gray w3-padding-16" style="width:50%">Professores</a>
			<a href="javascript:void(0)" onclick="w3_show_nav('menuDisc')"
			   class="w3-bar-item w3-button w3-theme w3-hover-light-gray w3-padding-16" style="width:50%">Disciplinas</a>
			<a href="javascript:void(0)" onclick="w3_show_nav('menuTurma')"
			   class="w3-bar-item w3-button w3-theme w3-hover-light-gray w3-padding-16" style="width:50%">Turma</a>
		...
		<div id="menuProf" class="myMenu">
			<div class="w3-container">
				<h3>Menu Professores</h3>
			</div>
			<a class="w3-bar-item w3-button" href="profListar.php">Relação de Professores</a>
			<a class="w3-bar-item w3-button" href="profIncluir.php">Contratação de Professores </a>
		...
		<div id="menuDisc" class="myMenu" >
			...
			<a class="w3-bar-item w3-button" href='discIncluir.php'>Criar Nova Disciplina</a>
