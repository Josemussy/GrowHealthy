                    ...
                    <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:500px">
                        ...
                        <form action="cadastro.php" method="POST" class="w3-container w3-card-4 w3-light-grey w3-margin" >
                            ...
                            <div class="w3-row w3-section" id="cre" style="display: none;">
                                ...
                                <input class="w3-input w3-border"  name="cre" type="text" placeholder=" " required>
                                </div>
                            </div>
                            ...
                            <div class="w3-row w3-section" id="crn" style="display: none;">
                                ...
                                <input class="w3-input w3-border"  name="crn" type="text" placeholder=" " required>
                                </div>
                            </div>
                            ...
                            <div class="w3-row w3-section" id="idade" style="display: none;">
                                <div class="w3-rest">
                                    ...
                                    <input class="w3-input w3-border" placeholder="Entre 12 anos a 99 anos" name="idade" type="text" placeholder=" " min="12" max="99" pattern="[0-9]+"  maxlength="2" required required onkeypress="return event.charCode >= 48 && event.charCode <= 57">
                            ...
                            <div class="w3-row w3-section" id="peso" style="display: none;">
                                ...
                                <input class="w3-input w3-border" type="text" id="peso" name="peso"  placeholder="EX: 68,90" pattern="^(\d{1,2})(\d{1,2})?$|^(\d{1,2})(\d{2})$" oninput="this.value=this.value.replace(/^(\d{1,2})(\d{1,2})?$|^(\d{1,2})(\d{2})$/, function(match, p1, p2, p3, p4) { return p1 ? p1 + (p2 ? ',' + p2 : '') : p3 + ',' + p4; })" maxlength="5" required onkeypress="return event.charCode >= 48 && event.charCode <= 57" >
                            ...
                            <div class="w3-row w3-section" id="altura" style="display: none;">
                                ...
                                <input class="w3-input w3-border" type="text" id="altura" name="altura"   placeholder="EX:171" maxlength="3" required onkeypress="return event.charCode >= 48 && event.charCode <= 57" >
                            ...
                            <div class="w3-row w3-section" id="descricao" style="display: none;">
                                <div class="w3-rest">
                                    ...
                                    <textarea class="w3-input w3-border" name="descricao" placeholder="Descreva se tem algum problema de saúde físico ou alimentar, caso não tenha diga que não tem" style="line-height: 1.5; max-width: 435px; min-width: 435px;min-height: 60px;"></textarea>
                                </div>
                            </div>
