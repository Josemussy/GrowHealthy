...
<body>
    ...
    $cre  = $conn->real_escape_string($_POST['cre']);  // prepara a string recebida para ser utilizada em comando SQL
    $idade  = $conn->real_escape_string($_POST['idade']);  // prepara a string recebida para ser utilizada em comando SQL
    ...
    $sql = "INSERT INTO TB_Usuario (Nome, Celular, Email, DataNasc, ID_Genero,cpf,tipo,crn,cre,idade,peso,altura,descricao, Login, Senha, ID_TipoUsu, Foto) VALUES ('$nome','$celular','$email', '$dt_nasc', '$genero','$cpf','$tipo','$crn','$cre','$idade','$peso','$altura','$descricao' ,'$login','$md5Senha', $tipoUsu, NULL)";
