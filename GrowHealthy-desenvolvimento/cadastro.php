...
<body>
    ...
    $sql = "INSERT INTO TB_Usuario (Nome, Celular, Email, DataNasc, ID_Genero, Login, Senha, ID_TipoUsu, Foto) VALUES ('$nome','$celular','$email', '$dt_nasc', '$genero','$login','$md5Senha', $tipoUsu, NULL)";
