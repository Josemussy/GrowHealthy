...
<html>
	<head>
		...
		<link rel="icon" type="image/png" href="imagens/logo1.png.png"/>
						...
						<form class="w3-container" action="ProfAtualizar_exe.php" method="post" enctype="multipart/form-data">
							<table class='w3-table-all'>
								<tr>
									...
									<p style="text-align:center"><label class="w3-text-cyan"><b>Revise e poste aqui o treino: </b></label></p>
