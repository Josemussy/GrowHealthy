							...
							<table class='w3-table-all'>
								<tr>
									...
									<td>
										...
										<p style="text-align:center"><label class="w3-text-cyan"><b>Minha Imagem para Identificação: </b></label></p>
										<?php
										if ($foto) { ?>
										...
										?>
										<p style="text-align:center"><label class="w3-btn w3-cyan">Selecione uma Imagem
